...
public class NeuralNetworkPlayer {
    ...
    public void trainSelfPlayWithLittleAndConstantEpsilon(int numIterations, int modelNumber, int traininginterval) throws IOException {
        int moveIndex = (int) (Math.random() * 9);
        int iterations = 0;
        int moves = 0;
